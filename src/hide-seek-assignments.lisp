...
(defun ask-user-hs (percept)
  ...
  (format t 
     "~&Percept is ~A; action (right midright forw midleft left pyky turnleft turnright)? " percept)
  (read))
...
(defmethod left ((env hs-world) agent-body &optional (args 1))
...
(defmethod right ((env hs-world) agent-body &optional (args 1))
