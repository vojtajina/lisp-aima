...
(defmethod left ((env bs-world) agent-body)
...
(defmethod right ((env bs-world) agent-body)
...
(defmethod forw ((env bs-world) agent-body)
...
(defmethod back ((env bs-world) agent-body)
...
(defmethod stop ((env bs-world) agent-body)
